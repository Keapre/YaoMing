...
public class Sensors {
    ...
    public static double targetXRedFar = targetXRedClose;
    public static double servoPos = 0.4;
    public static double targetYRedFar = targetYRedClose;
    public static double targetXBlueFar = targetXBlueClose;
    public static double targetYBlueFar = targetYBlueClose;
