...
public class FarConstants {
    ...
    public static double zoneSpeedThreshold = 85;
    public static int zoneSpeedShiftPose = -1;

    public static int cycleCount = 4;
    public static int hpCycleCount = 2;
    ...
    public static double scoreX = 59.64, scoreY = 13.73, scoreHeading = Math.PI/2;
    public Pose scorePose;
    public static double scoreXScoop = 58, scoreYScoop = 14.45, scoreHeadingScoop = -3.948;
    public Pose scorePoseScoop;


    public static double scoopPoseX = 29.09, scoopPoseY = 59.09, scoopPoseHeading = -4.037;
    public Pose scoopPose;
    ...
    public void buildPaths() {
        ...
        scorePoseScoop = new Pose(scoreXScoop, scoreYScoop * m, toBlobHeading(scoreHeadingScoop * m));
        scoopPose = new Pose(scoopPoseX, scoopPoseY * m, toBlobHeading(scoopPoseHeading * m));
    ...
    public int getHpCycleCount() { return hpCycleCount; }
}
