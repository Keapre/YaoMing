...
public class Launcher implements Module {
    ...
    public static double[] velValues = {1320, 1320, 1330, 1360, 1370, 1395, 1400, 1420, 1500, 1550, 1570, 1600, 1700, 1700, 1800, 2000, 2020, 2035, 2045, 2060, 2060, 2060, 2060};
    public static double[] hoodValues = {0.1, 0.1, 0.12, 0.12, 0.13, 0.16, 0.19, 0.20, 0.23, 0.27, 0.27, 0.33, 0.34, 0.36, 0.38, 0.39, 0.42, 0.43, 0.44, 0.45, 0.45, 0.45, 0.45};
